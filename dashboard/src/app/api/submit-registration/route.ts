...
export async function POST(request: NextRequest) {
  try {
    ...
    // 2. Extract user identification from answers
    ...
    console.error('💥 Unexpected error in submit-registration:', error);
    return NextResponse.json(
...
function extractValue(answers: Record<string, any>, possibleKeys: string[]): string | null {
